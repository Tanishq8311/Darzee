        ...
        <Card className="mb-6">
          <CardHeader className="text-center">
            ...
            <p className="text-muted-foreground">
              {user.shopName || 'Manage your tailoring business with precision'}
            </p>
        ...
        <div className="space-y-6">
          ...
          <Card>
            <CardHeader className="text-center">
              ...
              <p className="text-muted-foreground">
                Track your orders and connect with your tailor
              </p>
            </CardHeader>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <Card>
              <CardContent className="p-6 text-center">
                ...
                <CardTitle className="text-lg mb-1">Pending Payment</CardTitle>
